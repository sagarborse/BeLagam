...
if( !class_exists("ModuleSample") ) {
	class ModuleSample { 
		...
		public static function getStoreConfigs(){
			return array(
					'config_image_category_width' =>880,
					'config_image_category_height' => 208,
					
					'config_image_thumb_width' =>576,
					'config_image_thumb_height' => 500,
					
					'config_image_popup_width' =>600,
					'config_image_popup_height' => 521,
					
					'config_image_product_width' =>250,
					'config_image_product_height' => 217,
					
					'config_image_additional_width' =>80,
					'config_image_additional_height' => 69,
					
					'config_image_related_width' =>250,
					'config_image_related_height' => 217,
