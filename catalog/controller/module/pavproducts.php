...
class ControllerModulepavproducts extends Controller {
	...
	public function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/pavproducts.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/pavproducts.tpl', $this->data);
		} else {
			return $this->load->view('default/template/module/pavproducts.tpl', $this->data);
		}
	}
