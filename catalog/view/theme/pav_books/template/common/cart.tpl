...
<div id="cart" class="clearfix">
    <div data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="heading media dropdown-toggle"> 
      ...
      <div class="cart-inner media-body text-left hidden-xs">
    ...
    <ul class="dropdown-menu">
      ...
      <li>
        <div class="table-responsive">
          ...
          <p class="text-right">
            <a href="<?php echo $cart; ?>" class="button btn btn-outline">
              <?php echo $text_cart; ?>
            </a>&nbsp;&nbsp;&nbsp;
            <a href="<?php echo $checkout; ?>" class="button btn btn-outline">
