<?php $id = rand(1,10); $span =  12/$columns; ?>
    <div id="pavcarousel<?php echo $id;?>" class="box box-normal carousel slide pavcarousel">
		...
		<div class="box-content carousel-inner">
			...
			<div class="item <?php if($k==0) {?>active<?php } ?> no-margin">
				<?php foreach( $tbanners as $i => $banner ) {  $i=$i+1;?>
					...
					<div class="col-lg-<?php echo $span;?> col-md-<?php echo $span;?> col-sm-4 col-xs-12 column">
