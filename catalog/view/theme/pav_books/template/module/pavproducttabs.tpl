...
?>
<div class="box box-normal producttabs <?php echo $module_class;?>">
	<?php if( trim($module_description) ){ ?>
		<div class="module-desc hidden"><?php echo $objlang->get(trim($module_description)); ?></div>
	<?php } ?>
  <div class="htabs">
	<ul class="nav" id="producttabs<?php echo $id;?>">
