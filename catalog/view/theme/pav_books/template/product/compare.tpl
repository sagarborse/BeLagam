   ...
   <div id="content"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td class="text-center"><input style="margin: 10px 0;" type="button" value="<?php echo $button_cart; ?>" class="btn btn-primary" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" />
            <a href="<?php echo $product['remove']; ?>" class="btn btn-danger" style="margin: 10px 0;"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
    </div>
