...
<div class="product-info">    
  ...
  <div class="product-view col-xs-12 col-sm-6 col-md-6 col-lg-<?php echo $cols[1]; ?>">
    ...
    <div class="review">
        ...
        <div id="product">
          ...
          <div class="product-extra">                      
            <div class="quantity-adder clearfix pull-left">
            ...
            <div class="product-action clearfix">
                <div class="cart pull-left" style="margin: 2px 10px;">
                    <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-outline">
                        <span class="fa-fw fa fa-shopping-cart"></span><?php echo $button_cart; ?></button>
                </div>
                <div class="wishlist pull-left hidden">  
                    <a class="btn btn-outline-inverse" title="<?php echo $button_wishlist; ?>" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');"><span class="fa-fw fa fa-heart-o"></span><?php echo $button_wishlist; ?></a>
                </div>
                <div class="compare pull-left hidden">
                    <a class="btn btn-outline-inverse" title="<?php echo $button_compare; ?>" onclick="compare.addcompare('<?php echo $product_id; ?>');"><span class="fa-fw fa fa-retweet"></span><?php echo $button_compare; ?></a>
                </div>
            </div>
          </div>
