...
<div class="product-info">    
  ...
  <div class="product-view col-xs-12 col-sm-6 col-md-6 col-lg-<?php echo $cols[1]; ?>">
    ...
    <div id="product">
        <?php if ($options) { ?>
            <h3 class="available"><?php echo $text_option; ?></h3>
        ...
        <div class="product-extra">                      
            ...
            <div class="product-action clearfix">
                ...
                <div class="wishlist pull-left">  
                    <a class="btn btn-outline" title="<?php echo $button_wishlist; ?>" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');"><span class="fa-fw fa fa-heart-o"></span><?php echo $button_wishlist; ?></a>
                </div>
                <div class="compare pull-left">
                    <a class="btn btn-outline" title="<?php echo $button_compare; ?>" onclick="compare.addcompare('<?php echo $product_id; ?>');"><span class="fa-fw fa fa-retweet"></span><?php echo $button_compare; ?></a>
                </div>
            </div>
        </div>
